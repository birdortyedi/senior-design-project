    ...
    while True:
        ...
        for i, cnt in enumerate(contours):
            ...
            if not (area < 500 or area > tmp_size / 8):
                ...
                rszd_img = cv2.resize(crop_img, (64, 64))

                # To save images and manually label images, it is used.
                cv2.imwrite("C:/Users/fk2969/Desktop/ImageDataset/image_" + str(counter) + ".jpg", rszd_img)
                counter += 1
...
if __name__ == '__main__':
    read_data("C:/Users/fk2969/Desktop/VideoDataset/video4.mp4")
